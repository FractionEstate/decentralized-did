...
class ErrorCode(str, Enum):
    ...
    EXT_BLOCKFROST_ERROR = "EXT_BLOCKFROST_ERROR"
...
ERROR_CATEGORIES: Dict[ErrorCode, ErrorCategory] = {
    ...
    # External services
    ErrorCode.EXT_BLOCKFROST_ERROR: ErrorCategory.EXTERNAL_SERVICE,
...
ERROR_STATUS_CODES: Dict[ErrorCode, int] = {
    ...
    ErrorCode.EXT_BLOCKFROST_ERROR: status.HTTP_502_BAD_GATEWAY,
