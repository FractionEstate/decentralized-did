...
def cmd_demo_kit(args: argparse.Namespace) -> None:
    ...
    cip30_entries_json = json.dumps(cip30_inline["metadata"], indent=2)
    ...
    ts_lines = [
        ...
        "export const cip30MetadataEntries: Array<[number, unknown]> = ",
        textwrap.indent(cip30_entries_json, "  "),
        ";",
        ...
        textwrap.indent(helper_ts_json, "  "),
        " as const;",
        "",
    ]
