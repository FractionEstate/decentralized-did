export default {
  ...
  moduleNameMapper: {
    ...
    "^../config/env$": "<rootDir>/src/core/config/__mocks__/env.ts",
    "^ionicons/components/ion-icon.js$": "<rootDir>/src/ui/__mocks__/ionIconMock.ts",
    "^ionicons/icons$": "<rootDir>/src/ui/__mocks__/ionIconsMock.ts",
