...
enum ToastMsgType {
  ...
  BIOMETRIC_ENROLLMENT_SUCCESS = "biometricenrollmentsuccess",
  BIOMETRIC_ENROLLMENT_ERROR = "biometricenrollmenterror",
  BIOMETRIC_VERIFICATION_SUCCESS = "biometricverificationsuccess",
  BIOMETRIC_VERIFICATION_ERROR = "biometricverificationerror",
